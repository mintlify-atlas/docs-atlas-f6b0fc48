...
<AccordionGroup>
  ...
  <Accordion title="How do I set up server-side validation?">
    ...
    See the [Server-Side Validation Guide](https://github.com/openagentidentityprotocol/agentidentityprotocol/blob/main/implementations/go-proxy/docs/server-guide.md) for details.
  </Accordion>
</AccordionGroup>
