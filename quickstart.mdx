...
<CardGroup cols={2}>
  <Card title="GitHub Discussions" icon="github" href="https://github.com/ArangoGutierrez/agent-identity-protocol/discussions">
    Ask questions and share your AIP setup
  </Card>
  <Card title="Report Issues" icon="bug" href="https://github.com/ArangoGutierrez/agent-identity-protocol/issues">
    Found a bug? Let us know
  </Card>
  <Card title="FAQ" icon="circle-question" href="/community/faq">
    Common questions answered
  </Card>
  <Card title="Contributing" icon="code-pull-request" href="https://github.com/ArangoGutierrez/agent-identity-protocol/blob/main/CONTRIBUTING.md">
    Help build AIP
  </Card>
</CardGroup>
