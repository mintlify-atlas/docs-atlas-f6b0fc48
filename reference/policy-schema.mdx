...
- [JSON Schema (v1alpha2)](https://github.com/openagentidentityprotocol/agentidentityprotocol/blob/main/spec/schema/agent-policy-v1alpha2.schema.json)
- [JSON Schema (v1alpha1)](https://github.com/openagentidentityprotocol/agentidentityprotocol/blob/main/spec/schema/agent-policy.schema.json)