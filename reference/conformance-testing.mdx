...
- **Conformance Suite:** [`spec/conformance/`](https://github.com/openagentidentityprotocol/agentidentityprotocol/tree/main/spec/conformance)
- **JSON Schemas:** [`spec/schema/`](https://github.com/openagentidentityprotocol/agentidentityprotocol/tree/main/spec/schema)
- **Reference Implementation:** [Go Proxy](https://github.com/openagentidentityprotocol/aip-go)
- **Submit Issues:** [GitHub Issues](https://github.com/openagentidentityprotocol/agentidentityprotocol/issues)
