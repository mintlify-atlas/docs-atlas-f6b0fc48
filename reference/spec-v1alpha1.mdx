...
<Card title="Download Formal Specification" icon="file-pdf" href="https://github.com/openagentidentityprotocol/agentidentityprotocol/blob/main/spec/aip-v1alpha1.md">
